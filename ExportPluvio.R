# ExportPluvio versione R per connessione con webservice 
# by MM
# Script R
# questa versione sostituisce l'exportpluvio di Windows
# 1.collegamento con dB per ottenere gli ID dei pluviometri
# 2.collegamento con webservice per richiesta dati
# 3.calcolo delle cumulate
